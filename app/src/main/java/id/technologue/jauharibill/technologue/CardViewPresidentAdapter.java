...
public class CardViewPresidentAdapter extends RecyclerView.Adapter<CardViewPresidentAdapter.CardViewViewHolder>{
    ...
    public ArrayList<President> getLiistPresident(){
    ...
    public void onBindViewHolder(CardViewViewHolder holder, int position){
        President p = getLiistPresident().get(position);
        ...
        holder.btnFavorite.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback(){
            ...
            public void onItemClicked(View view, int position){
                Toast.makeText(context, "share" + getLiistPresident().get(position).getName(), Toast.LENGTH_SHORT  ).show();
            }
        }));
